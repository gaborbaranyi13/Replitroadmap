        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-600 mb-4">Transform your business idea into a strategic action plan with our AI-powered roadmap generator.</p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-600 hover:text-primary-600 transition-colors">Examples</a></li>
          ...
          <div className="border-t border-gray-200 mt-8 pt-8 text-center text-gray-500">
            <p>&copy; {new Date().getFullYear()} Business Roadmap Generator. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
